        ...
        if 1 <= choice <= len(concerts):
            ...
            while True:
                ...
                if buy_ticket.lower() == "ya":
                    ...
                    break
                elif buy_ticket.lower() == "tidak":
                    view_other_concerts = ""
                    while view_other_concerts.lower() not in ["ya", "tidak"]:
                        view_other_concerts = input("Apakah Anda ingin melihat konser yang lain? (ya/tidak): ")
                        if view_other_concerts.lower() not in ["ya", "tidak"]:
...
def buy_vip_ticket(concert):
    ...
    while "@" not in email:
        ...
        if "@" not in email:
            print("Email yang Anda masukkan tidak valid. Mohon masukkan email dengan benar.")
